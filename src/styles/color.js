...
// export const colorPrimaryHover = "#00ff00";
export const colorPrimaryFocus = teal900;
export const colorPrimaryActive = teal900;
// export const colorPrimaryActive = "#0000ff";
export const colorPrimaryDisabled = gray600;
